...
class VAEXperiment(pl.LightningModule): 
    ...
    def forward(self, input: Tensor,epoch: int = None, max_epoch: int = None,status='Train', **kwargs) -> Tensor: 
        return self.model(input, epoch = epoch, max_epoch = max_epoch, status=status, **kwargs) 
