...
# Save a copy of the config file into the log directory (version_xx/)
log_dir = tb_logger.log_dir
Path(log_dir).mkdir(parents=True, exist_ok=True)

# Option 1: copy the original config file
shutil.copy(args.filename, os.path.join(log_dir, "config.yaml"))

# Option 2: or dump the parsed config dict
with open(os.path.join(log_dir, "config_resolved.yaml"), "w") as f:
